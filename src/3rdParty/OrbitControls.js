...
var OrbitControls = function (object, domElement) {
  ...
  this.update = (function (mousePos) {
    ...
    return function update (mousePos) {
      if (mousePos) {
  ...
  function handleMouseMoveRotate (mousePos) {
  ...
  function simulateClick (domElement) {
    handleMouseDownRotate({ clientX: domElement.clientWidth / 2, clientY: domElement.clientHeight / 2 })
    state = STATE.ROTATE
  }
  ...
  simulateClick(scope.domElement)
